...
<div class="card shadow-lg mt-4">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.baptisms.records.update', $record->id) }}">
            @csrf
            @method('PUT')
            ...
            {{-- <div class="form-group">
                ...
                <input type="text" name="baptism_parish" class="form-control"
                       value="{{ $record->parish->name }}" required>
            </div> --}}
